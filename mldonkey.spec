...
Name:		mldonkey
%define ocaml_ver	3.08.2
%define patch_pack	c
%define real_ver	2.5.30.1
...
Source0:       http://download.berlios.de/pub/mldonkey/spiralvoice/cvs/%{name}-2.5.30-1.tar.bz2
# Source0-md5:	b41531257d898ef5b27d99ac6b6a0520
Source1:	%{name}.init
